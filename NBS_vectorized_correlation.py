'''
This code wasn't made by James O'Connell - Referenced in portfolio, and used in fc_Connectome_Analysis.py
'''
...
def nbs_bct_corr_z(corr_arr, thresh, y_vec, k=1000, extent=True, verbose=False):
    ...
    for u in range(k):
        ...
        if verbose:
            ...
            print('permutation %i of %i.  p-value so far is %.8f' % (u, k,
                                                                     hit / (u + 1)))
